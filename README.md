...
| [`@uphold/opentelemetry-instrumentation-temporalio-sdk`](./packages/opentelemetry-instrumentation-temporalio-sdk/) | OpenTelemetry instrumentation for Temporal SDK that automatically installs interceptors |
